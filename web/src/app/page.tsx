  ...
  return (
    ...
    {/* Left */}
      <div className="bg-[url(../assets/bg-stars.svg)] bg-cover flex flex-col items-start justify-between px-28 py-16 relative overflow-hidden border-r border-white/10">
        {/* Blur */}
        <div className="absolute right-0 top-1/2 h-[280px] w-[526px] bg-purple-700 opacity-50 -translate-y-1/2 translate-x-1/2 rounded-full blur-full"/>
        {/* Stripes */}
        ...
        <div className='space-y-5'>
          ...
          <div className='max-w-[420px] space-y-1'>
            ...
            <p className='text-lg leading-relaxed'>
              Colecione momentos importantes na sua jornada e compartilhe (se quiser) com o mundo!
            </p>
          </div>
        ...
        <div className='text-sm leading-relaxed text-gray-200'>
          Feito com amor no NLW da <a target='_blank' rel='noreferrer' className='underline hover:text-gray-100' href="https://rocketseat.com.br">Rocketseat</a>
        </div>
      </div>
    {/* Right */}
